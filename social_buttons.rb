def social_buttons
  ...
  <div class="social-buttons" style="text-align:right">
      ...
      <a href="http://b.hatena.ne.jp/entry/#{url_with_slash.sub(/\Ahttps?:\/\//, '')}?#{@conf.options['page']}" class="hatena-bookmark-button" title="Add this entry to Hatena Bookmark"><img src="http://b.st-hatena.com/images/entry-button/button-only.gif" alt="Add this entry to Hatena Bookmark" width="20" height="20" style="border: none;" /></a>
